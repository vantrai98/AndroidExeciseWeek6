...
import com.vantrai.challengew6.model.NowPlayingMovie
...
class NowPlayingFragment : Fragment() {
    private val BUNDEL_RCV_STATE: String = "bundel_rcv_state"
    ...
    private val title: String = "Now Playing"
    ...
    private fun getMovieListFromDataCenter(): ArrayList<Movie> {
        val data = Gson().fromJson<NowPlayingMovie>(
    ...
    private fun getMovieListFromApi() {
        ...
        MovieService.getInstance().getApi().getNowPlaying(pageIndex).enqueue(
